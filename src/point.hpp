...
class Point : public Figure {
  public:
    ...
    void set(ValueType value, unsigned int dimension);
    void set_at(ValueType value, unsigned int dimension);

    std::vector<ValueType> get() const noexcept;
    ValueType get(unsigned int dimension) const;
...
template<typename ValueType, unsigned int Dimension>
void Point<ValueType, Dimension>::set(ValueType value, unsigned int dimension) {
...
template<typename ValueType, unsigned int Dimension>
ValueType Point<ValueType, Dimension>::get(unsigned int dimension) const {
